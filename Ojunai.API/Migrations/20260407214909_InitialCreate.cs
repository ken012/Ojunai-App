        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Channel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "WhatsApp"),
                    RawMessage = table.Column<string>(type: "text", nullable: false),
                    ParsedIntent = table.Column<string>(type: "text", nullable: true),
                    ParsedPayloadJson = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetCashIn = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    OutstandingReceivables = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    OutstandingPayables = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailySummaries_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LedgerEntries_Contacts_ContactId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailySummaries_BusinessId_Date",
                table: "DailySummaries",
                columns: new[] { "BusinessId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Expenses_BusinessId_CreatedAtUtc",
                table: "Expenses",
                columns: new[] { "BusinessId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_BusinessId_CreatedAtUtc",
                table: "InventoryTransactions",
                columns: new[] { "BusinessId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_BusinessId_ProductId",
                table: "InventoryTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_BusinessId_ContactId",
                table: "LedgerEntries",
                columns: new[] { "BusinessId", "ContactId" });

            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_BusinessId_EntryType",
                table: "LedgerEntries",
                columns: new[] { "BusinessId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_ContactId",
                table: "LedgerEntries",
                column: "ContactId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageLogs_WhatsAppMessageId",
                table: "MessageLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_BusinessId_CreatedAtUtc",
                table: "Sales",
                columns: new[] { "BusinessId", "CreatedAtUtc" });
