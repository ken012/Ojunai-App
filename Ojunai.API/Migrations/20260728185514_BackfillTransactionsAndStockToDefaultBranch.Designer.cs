...
namespace Ojunai.API.Migrations
{
    ...
    [Migration("20260728185514_BackfillTransactionsAndStockToDefaultBranch")]
    partial class BackfillTransactionsAndStockToDefaultBranch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ojunai.API.Models.ActionUsage", b =>
                {
                    ...
                    b.Property<int>("WhatsAppCount")
                        .HasColumnType("integer");

                    b.HasKey("BusinessId", "ProductLine", "PeriodStartUtc");

                    b.ToTable("ActionUsages");
                });

            modelBuilder.Entity("Ojunai.API.Models.ActivityLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ActorChannel")
                        .IsRequired()
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("Ojunai.API.Models.AdminAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.AdminMetricSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ChannelFilter")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("MetricName", "CapturedDate");

                    b.HasIndex("MetricName", "ChannelFilter", "CapturedDate")
                        .IsUnique();

                    b.ToTable("AdminMetricSnapshots");
                });
            ...
            modelBuilder.Entity("Ojunai.API.Models.BundleComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BusinessId", "BundleProductId");
            ...
            modelBuilder.Entity("Ojunai.API.Models.Business", b =>
                {
                    ...
                    b.Property<bool>("AlertDailyNudges")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal>("ConfirmLargeSaleThresholdMessenger")
                        .HasColumnType("numeric");

                    b.Property<decimal>("ConfirmLargeSaleThresholdTelegram")
                        .HasColumnType("numeric");

                    b.Property<bool>("ConfirmLargeSales")
                        .HasColumnType("boolean");

                    b.Property<bool>("ConfirmLargeSalesMessenger")
                        .HasColumnType("boolean");

                    b.Property<bool>("ConfirmLargeSalesTelegram")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("LargeSaleAlertDashboard")
                        .HasColumnType("boolean");

                    b.Property<bool>("LargeSaleAlertMessenger")
                        .HasColumnType("boolean");

                    b.Property<bool>("LargeSaleAlertTelegram")
                        .HasColumnType("boolean");

                    b.Property<bool>("LargeSaleAlertWhatsApp")
                        .HasColumnType("boolean");

                    b.Property<decimal>("LargeSaleThreshold")
                        .HasColumnType("numeric");

                    b.Property<DateOnly?>("LastDailyNudgeOn")
                        .HasColumnType("date");
                    ...
                    b.Property<int>("VoiceAICycleMinutesUsed")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VoiceAITier")
                        .HasColumnType("text");

                    b.Property<DateTime?>("VoiceAITrialEndsAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("VoiceAITrialMinutesUsed")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ojunai.API.Models.BusinessOverride", b =>
                {
                    ...
                    b.ToTable("BusinessOverrides");
                });

            modelBuilder.Entity("Ojunai.API.Models.ChannelLinkToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BoundToIdentity")
                        .HasMaxLength(120)
            ...
            modelBuilder.Entity("Ojunai.API.Models.Expense", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "LocationId", "CreatedAtUtc");
            ...
            modelBuilder.Entity("Ojunai.API.Models.InboundMessageClaim", b =>
                {
                    b.Property<int>("Channel")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Channel", "ProviderMessageId");

                    b.HasIndex("ClaimedAtUtc");

                    b.ToTable("InboundMessageClaims");
                });
            ...
            modelBuilder.Entity("Ojunai.API.Models.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.PendingTelegramAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PendingTelegramActions");
                });
            ...
            modelBuilder.Entity("Ojunai.API.Models.Product", b =>
                {
                    ...
                    b.HasIndex("VariantGroupId")
                        .HasFilter("\"VariantGroupId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Ojunai.API.Models.ProductBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("WrittenOffAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Ojunai.API.Models.ProductLocationStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProductLocationStocks", t =>
                        {
                            t.HasCheckConstraint("CK_ProductLocationStock_CurrentStock_NonNegative", "\"CurrentStock\" >= 0");
                        });
                });

            modelBuilder.Entity("Ojunai.API.Models.PurchaseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PayableLedgerEntryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.PurchaseOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.Sale", b =>
                {
                    ...
                    b.Property<DateTime?>("ReceiptGeneratedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Ojunai.API.Models.SignupChannelToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ConsumedByIdentity")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
            ...
            modelBuilder.Entity("Ojunai.API.Models.StockTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.Stocktake", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.StocktakeItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.SuppressedEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.User", b =>
                {
                    ...
                    b.Property<Guid?>("SelectedLocationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.UserLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.VariantGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ojunai.API.Models.ProductLocationStock", b =>
                {
                    b.HasOne("Ojunai.API.Models.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Ojunai.API.Models.PurchaseOrderItem", b =>
                {
                    b.HasOne("Ojunai.API.Models.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Ojunai.API.Models.StocktakeItem", b =>
                {
                    b.HasOne("Ojunai.API.Models.Stocktake", "Stocktake")
                        .WithMany("Items")
