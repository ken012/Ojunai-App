...
public class WhatsAppService : IWhatsAppService
{
    ...
    private async Task<string> HandleCreateExpenseAsync(Guid businessId, JsonElement ba, User? recordedBy = null)
    {
        ...
        var inventoryKeywords = new[] { "inventory", "stock", "goods for", "raw material", "merchandise", "replenish", "restock" };
        ...
        _ = Task.Run(async () =>
        {
            try
            {
                await SendMessageAsync($"whatsapp:{normalizedPhone}",
                    ...
                    $"1. Go to app.ojunai.com/forgot-password\n" +
    ...
    private static string HandleGreet(string businessName) =>
        $"👋 Hi! I'm your Ojunai assistant for *{businessName}*.\n\n" +
        "🛒 \"Sold 3 bags of rice\"\n" +
    ...
    private string HandleGetExportLink(Guid businessId, JsonElement ba, User user)
    {
        ...
        return $"📥 *Your {label} is ready!*\n\n" +
               ...
               $"Need a different date range or format? Visit app.ojunai.com/export";
    }
    ...
    private static string HandleGetMyAccount(User user) =>
        ...
        $"\nManage your account at app.ojunai.com/settings";
    ...
    private static string HandleGetPlans()
    {
        ...
        sb.AppendLine("Say *subscribe to [plan]* to get started, or manage at app.ojunai.com/settings");
        return sb.ToString().TrimEnd();
    }
    ...
    private async Task<string> HandleSubscribeAsync(Guid businessId, JsonElement ba, User? user)
    {
        ...
        catch (Exception ex)
        {
            ...
            return "Sorry, couldn't set up payment right now. Please try again or visit app.ojunai.com/settings to subscribe.";
        }
    }
    ...
    private async Task<string> HandleCancelSubscriptionAsync(Guid businessId, JsonElement ba)
    {
        ...
        catch (Exception ex)
        {
            ...
            return "Sorry, couldn't cancel right now. Please try again or visit app.ojunai.com/settings.";
        }
    }
