...
const FORMATS: Record<ImportType, { headers: string; example: string; required: string; optional: string; permission: string; label: string }> = {
  ...
  sales: {
    label: "Sales",
    headers: "ProductName,Quantity,UnitPrice,CustomerName,PaymentStatus,Date",
    example: "Rice,5,5000,Emeka,Paid,2026-03-15\nShampoo,3,2500,Ngozi,Unpaid,2026-03-16",
  ...
  expenses: {
    label: "Expenses",
    headers: "Category,Amount,PaidTo,Notes,Date",
    example: "Transport,5000,Driver,Market run,2026-03-15\nRent,100000,Landlord,Monthly rent,2026-03-01\nElectricity,15000,NEPA,April bill,2026-04-05",
    required: "Category, Amount, Date",
    optional: "PaidTo, Notes, ExpenseType (operating or cogs)",
